	.file	"table-10-classes-test.cpp"
...
.LFB1310:
	.cfi_startproc
	movslq	%edi, %rdi
	movq	_ZL13property_apis(,%rdi,8), %rax
	ret
	.cfi_endproc
.LFE1310:
...
.LFB1311:
	...
	movq	_ZL13property_apis(,%rdi,8), %rdi
	movq	(%rdi), %rax
	call	*(%rax)
	addq	$8, %rsp
...
.L19:
	...
	addl	%r12d, %ebx
	movslq	%ebx, %rbx
	movq	_ZL13property_apis(,%rbx,8), %rbp
	movl	$1000000000, %ebx
	.p2align 4,,10
	.p2align 3
.L17:
